          ...
          <div class="row">
            <div class="col-md-12 text-center mb-3">
              <h3 className="reserve_modal_title" style={input_labels}>
                New Reservation
                <span className="" style={crossBtn} onClick={closeModal}>
                  X
                </span>
              </h3>
            </div>
            <div class="col-md-6">
              <div className="form-group login_inputs">
                <label
                  className="reserve_modal_input_label"
                  style={input_labels}
                >
                  {from_reservation
                ...
                <input
                  name="text"
                  value={bed_holder}
                  onChange={(e) => setBedHolder(e.target.value)}
                  type="text"
                  placeholder={from_reservation ? `Name of bed holder` : `NAME`}
              ...
              <div className="progress_card mt-4">
                <h5 className="">
                  {from_reservation
                    ...
                    : `HOW LONG SHOULD WE HOLD THE BED`}
                </h5>
            ...
            <div class="col-md-12">
              <div className="signup_footer">
                ...
                <p className="footer_sign_up" onClick={closeModal}>
                  CANCEL
                </p>
              </div>
            </div>
